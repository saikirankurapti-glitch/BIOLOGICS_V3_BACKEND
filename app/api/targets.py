...
async def create_target(target: TargetCreate, user: User = Depends(require_tokens(5, "Target Explorer"))):
...
async def import_pdb_target(pdb_id: str, user: User = Depends(require_tokens(5, "Target Explorer"))):
    """
...
async def discover_target(uniprot_id: str, user: User = Depends(require_tokens(5, "Target Explorer"))):
    """
