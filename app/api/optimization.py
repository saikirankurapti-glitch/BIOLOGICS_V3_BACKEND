...
async def run_optimization(target_id: str, constraints: dict, background_tasks: BackgroundTasks, current_user: User = Depends(require_tokens(100, "Lead Optimization")), model: str = "ga"):
