...
class BioDiscoveryReport(FPDF):
    def __init__(self, generated_by: str = "GenesysQuantis Researcher"):
        super().__init__()
    ...
    def header(self):
        ...
        self.cell(0, 10, 'GenesysQuantis Discovery Platform', 0, 1, 'C')
    ...
    def footer(self):
        ...
        self.cell(0, 10, 'GenesysQuantis Discovery Platform | Confidential', 0, 0, 'R')
...
def generate_pdf_report(target_name: str, summary_data: dict, molecules: list, user=None):
    ...
    """
    generated_by = "GenesysQuantis Researcher"
    if user is not None:
